...
### Step 1: Download the Scripts / 第一步：下载脚本
...
### Step 2: Setup the Local Data Source / 第二步：配置本地数据源
...
#### Method 1: The "Taichi" Way (Recommended, Mac Only) / 方法一：“Taichi” 方式（推荐，仅限 Mac）
...
#### Method 2: The DIY Mock Server / 方法二：自建 Mock 服务
...
### Step 3: Configure Antigravity / 第三步：配置 Antigravity
Finally, you need to tell the Antigravity to load these custom scripts.
